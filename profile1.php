...
<?php
    ...
    $q="select * from user_list where id=$no";
...
<div class="container  text-center ">
 <div class="row text-center h-100 bg-white">
	...
	USER NAME:  <?php echo $row["userid"];?><br>
     ...
     user account money :<?php echo $row["current_money"]; ?><br>
     user last trangection :<?php echo $row["last_tranfer"]; ?><br>
       
    <form class="form-signin p-5  text-white" action="" method="post">

        

        <button class="btn btn-lg btn-primary btn-block" type="submit" name="sub">view_list</button>
        <button type="submit" class="btn btn-lg btn-primary btn-block" name="sub1" >tranfer money</button>
